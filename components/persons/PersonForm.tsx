...
import sswFields from "@/data/master/ssw-fields.json";
import titpJobs from "@/data/master/titp-jobs.json";
...
export function PersonForm({
  ...
  const occupationOptions = useMemo(() => (form.currentProgram === "SSW" ? sswFields : titpJobs), [form.currentProgram]);
        ...
        <div className="grid gap-3 md:grid-cols-2">
          ...
          <label className={labelClassName}>
            ...
            <select
              ...
              onChange={(e) => setForm({ ...form, occupationField: e.target.value })}
            >
              <option value="">選択</option>
